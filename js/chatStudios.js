...
var Fake = [
  '¿Alguna vez has experimentado una tragedia? O ¿conoces a alguien?',
  '¿Cuál fue esa tragedia?',
  '¡Wow! Gracias por contarnos tu historia.',
...
function fakeMessage() {
  ...
  $('<div class="message loading new"><figure class="avatar"><img src="imagenes/nina.png" /></figure><span></span></div>').appendTo($('.mCSB_container'));
  updateScrollbar();

  setTimeout(function() {
    $('.message.loading').remove();
    $('<div class="message new"><figure class="avatar"><img src="imagenes/nina.png" /></figure>' + Fake[i] + '</div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();
    updateScrollbar();
    i++;
  }, 1000 + (Math.random() * 20) * 100);
